   ...
   <div class="container">
      <div class="row">
         <div class="col-md-4 pt-4">
            ...
            <p class="pt-1">
               HuynhKhanhShop là hệ thống bán sĩ và lẽ thời trang nam
            ...
            <p class="pt-1">
               Điện thoại: 0847 747 791(call, zalo) - Email: huynhkhanh@gmail.com
            </p>
...
<section class="dhl-copyright bg-dark py-3">
   <div class="container text-center text-white">
      Thiết kế bởi: Huỳnh Duy Khánh - Phone: 0847747791
      </div>
</section>
</body>
