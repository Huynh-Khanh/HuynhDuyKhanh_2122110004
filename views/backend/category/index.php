                           ...
                           <?php if (count($list) > 0) : ?>
                              <?php foreach ($list as $item) : ?>
                                    <tr>
                                       ...
                                       <td class="text-center">
                                          <img src="../public/images/category/<?= $item->image; ?>" class="img-fluid" alt="hinhanh">
                                       </td>
                                       <td class="text-center">
                                          <?= $item->name; ?>
                                       </td>
